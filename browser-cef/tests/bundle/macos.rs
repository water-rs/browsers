...
//!
//! Nothing here has a counterpart on Linux or Windows: those platforms have no
//! application bundle, Chromium re-executes the test binary itself for every
//! child process, and the runtime is resolved beside that binary rather than
//! inside a bundle. The module is compiled on macOS alone.
//!
...
const EXECUTABLE: &str = "waterui-cef-real-engine";
